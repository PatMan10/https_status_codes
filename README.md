...
This is done automatically by running `deno run --allow-read --allow-write --unstable src/app/main/typescript/app.ts`.
...
This is a port of [prettymuchbryce's](https://github.com/prettymuchbryce) NPM library [http-status-codes](https://www.npmjs.com/package/http-status-codes) for [deno](https://deno.land/).
